...
st.set_page_config(page_title="Canada Wildfire Risk Detector", page_icon="🔥")

st.title("🔥 Canada Wildfire Risk Detector")
...
if uploaded_file:
    ...
    try:
        ...
        geolocator = Nominatim(
            user_agent="canada_wildfire_detector"
        )
        ...
        st.subheader("🔥 Wildfire Assessment")
